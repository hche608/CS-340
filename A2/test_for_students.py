...
def test_sync():
    os.system("python3 A2.py dir1 dir2 -m")
...
def setup_with_overlap_and_subdirectories():
    ...
    for name in ["dir1", "dir1/dir1_1", "dir1/dir1_1/dir1_1_1",
                 "dir1/dir1_2", "dir2", "dir2/dir2_1"]:
        os.mkdir(name)
    # make the initial files
    make_file("dir1/file1_1.txt", "Not very exciting really.")
    make_file("dir1/file1_2.txt", "Also, not very exciting.")
    make_file(
        "dir1/dir1_1/dir1_1_1/file1_1_1_1.txt",
        "But the pathname is exciting.")
...
# Run different parts of this test program by un/commenting the bits you
# do/don't want.
